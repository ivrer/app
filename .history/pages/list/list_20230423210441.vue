<template>
	<view class="pageView">
		...
		<view class="moveBox" ref="nodeMoveBox" @click="triggerMove" @touchmove="BoxTouchmove">y移动盒子</view>
...
<script setup>
	...
	let BoxTouchmove = (e) => {
		// console.log(e,"e")
		//  let x = e.touches[0].pageX + "px"
		//  let y =  e.touches[0].pageY + "px"
		//  console.log(nodeMoveBox.value.$el)
		 console.log('divBox:', divBox.value)
		//  nodeMoveBox.value.style.top = x
		//  nodeMoveBox.value.style.left = y
		#ifdef MP-WEIXIn
		#enif
